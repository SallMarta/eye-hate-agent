...
- **Adapters:** Agent-specific formatters (Claude, Copilot, Antigravity) that mutate the raw template before saving it to the target platform instruction surface (e.g., `.agents/`).
