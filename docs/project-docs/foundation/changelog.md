...
- **New Highly-Specialized Skills:** Added `db-schema-design`, `ui-ux-implementation`, `refactor-specialist`, `ci-cd-authoring`, and `observability-setup` to grant agents strict, tactical abilities.
